        ...
        <div class="simple-stem-nav">
            ...
            >
                <template v-slot:activator="{ props }">
                    <div id="menuS" class="stem-nav-hover"
                ...
                <v-list id="nav-menu">
                    ...
                    >
                        <v-list-item-title>
                            <a class="link-nav" :href="item.link">{{ item.title }}</a>
                        </v-list-item-title>
                    </v-list-item>
                </v-list>
            </v-menu>
            ...
            >
                <template v-slot:activator="{ props }">
                    <div class="stem-nav-hover" id="menuT"
                         style="cursor: pointer"
                         v-bind="props"
                    >
                        T
            ...
            >
                <template v-slot:activator="{ props }">
                    <div id="menuE" class="stem-nav-hover"
                         style="cursor: pointer"
                         v-bind="props"
                    >
                        E
            ...
            >
                <template v-slot:activator="{ props }">
                    <div id="menuM" class="stem-nav-hover"
                         style="cursor: pointer"
                         v-bind="props"
                    >
                        M
...
export default {
    ...
    data() {
        return {
            menuS: [
                { title: 'Artigos', link: '/articles/sci' },
                { title: 'Tutoriais', link: '/tutorials' },
                { title: 'Mapas Mentais', link: '/mindmaps'},
                { title: 'Busque por tópicos', link: '/topics'},
                { title: 'Busque por autores', link: '/authors'},
                { title: 'Envie seu artigo', link: '/articles/new' },


            ],
            menuT: [
                { title: 'Artigos', link: '/articles/tech' },
                { title: 'Tutoriais', link: '/tutorials' },
                { title: 'Mapas Mentais', link: '/mindmaps'},
                { title: 'Busque por tópicos', link: '/topics'},
                { title: 'Busque por autores', link: '/authors'},
            ...
            menuE: [
                { title: 'Artigos', link: '/articles/eng' },
                { title: 'Tutoriais', link: '/tutorials' },
                { title: 'Mapas Mentais', link: '/mindmaps'},
                { title: 'Busque por tópicos', link: '/topics'},
                { title: 'Busque por autores', link: '/authors'},
            ...
            menuM: [
                { title: 'Artigos', link: '/articles/math' },
                { title: 'Tutoriais', link: '/tutorials' },
                { title: 'Mapas Mentais', link: '/mindmaps'},
                { title: 'Busque por tópicos', link: '/topics'},
                { title: 'Busque por autores', link: '/authors'},
